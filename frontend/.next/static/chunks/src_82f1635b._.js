...
;
;
function TodoItem({ todo, onEdit, onAction }) {
    ...
    const handleDelete = async ()=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$todo$2f$deleteTodo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteTodo"])(todo._id);
            onAction();
        } catch (err) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
        className: "flex justify-between items-center p-4 border rounded-md shadow-sm bg-white dark:bg-gray-800",
        children: [
...
_s(TodoList, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
...
function TodoPage() {
    ...
    const fetchTodos = async ()=>{
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$todo$2f$listTodo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listTodo"])();
        setTodos(data);
    };
...
_s(TodoPage, "/4U9Nw414wdNPFyacvT9TkTu07I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_82f1635b._.js.map
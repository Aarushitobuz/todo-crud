...
function RegisterPage() {
    ...
    const onSubmit = async (data)=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/register', data);
...
_s(RegisterPage, "tgLa7QbVeccjlqFABJspWJdggVk=", false, function() {
    return [

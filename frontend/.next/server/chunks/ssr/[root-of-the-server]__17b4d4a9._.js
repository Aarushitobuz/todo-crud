...
function TodoItem({ todo, onEdit, onAction }) {
    ...
    const handleDelete = async ()=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$todo$2f$deleteTodo$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteTodo"])(todo._id);
            onAction();
        } catch (err) {
...
function TodoPage() {
    ...
    const fetchTodos = async ()=>{
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$todo$2f$listTodo$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["listTodo"])();
        setTodos(data);
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__17b4d4a9._.js.map
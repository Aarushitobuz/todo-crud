...
"[project]/src/lib/todo/getTodo.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getTodo = async (id)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/todo/todos/${id}`);
...
"[project]/src/app/todos/edit/[id]/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$todo$2f$getTodo$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/todo/getTodo.ts [app-ssr] (ecmascript)");
...
function EditTodoPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (typeof id === 'string') {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$todo$2f$getTodo$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTodo"])(id).then((data)=>{
                setTodo(data);
            }).catch((err)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__68617e31._.js.map